...
class Seq2SeqTransformer(nn.Module):
    def __init__(self, num_encoder_layers: int, num_decoder_layers: int,
                 ...
                 dim_feedforward:int = 512, dropout:float = 0.1, nhead=1):
    ...
    def forward(self, src: Tensor, trg: Tensor, src_mask: Tensor,
        ...
        return torch.nn.functional.log_softmax(self.generator(outs))
...
def create_mask(src, tgt, padding_idx, device=torch.device('cpu')):
